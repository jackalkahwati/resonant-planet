          ...
          <Card>
            ...
            <CardContent>
              <div className="aspect-video bg-muted rounded-lg overflow-hidden">
                <img 
                  src={`${API_BASE_URL}${candidate.plots.phase_fold_png}`} 
            ...
            <CardContent>
              <div className="aspect-video bg-muted rounded-lg overflow-hidden">
                {candidate.plots.bls_png ? (
                  <img 
                    src={`${API_BASE_URL}${candidate.plots.bls_png}`} 
                    alt="BLS periodogram"
                    className="w-full h-full object-contain"
                  />
                ) : (
          ...
          <Card>
            ...
            <CardContent>
              <div className="aspect-video bg-muted rounded-lg overflow-hidden mb-4">
                <img 
                  src={`${API_BASE_URL}${candidate.plots.oddeven_png}`} 
        ...
        <TabsContent value="secondary" className="space-y-6">
          <Card>
            ...
            <CardContent>
              <div className="aspect-video bg-muted rounded-lg overflow-hidden">
                <img 
                  src={`${API_BASE_URL}${candidate.plots.secondary_png}`} 
